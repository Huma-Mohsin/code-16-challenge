...
const[,laptop1,laptop3]=laptops_info//In the code here const [, laptop1, laptop3] = laptops_info;, the syntax [, laptop1, laptop3] is used for array destructuring. This syntax is utilized when we want to ignore certain elements of the array during destructuring.
